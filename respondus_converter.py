...
(Answer:\s+True)|(Answer:\s+False)                                    # find True and False type
...
def main():     
    def process_test(test):
        ...
        if answer_match:
            ...
            test = string_replace(true_false_regex, "A) True\nB) False\n", test)
            test = string_replace(answer_regex, '', test)
            test = string_replace(feedback_regex, '', test)
            print test
    ...
    def format_answers(answers):
        ...
        for answer in answers:
            ...
            answers = string_replace(stats_regex, "", answers)
